                    ...
                    <div class="col-lg-3">
                        <ul class="nav nav-tabs flex-column">
                            ...
                            <li class="nav-item">
                             ...
                             <!-- <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tab-5">Video Recordings</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tab-6">Next Batch Details</a>
                            </li>
                           <li class="nav-item">
                ...
                <div class="col-lg-9 mt-4 mt-lg-0">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tab-5">
                            <div class="row">
                                <div class="col-lg-8 details order-2 order-lg-1">
                                    ...
                                    <p>Can't attend classes ?  watch our recordings of complete training</p>
                                    <p>
                                        <!-- <iframe width="500" height="215"
                                                src="https://videos.cdn.sap.com/vod/2019/what-is-sap-intelligent-robotic-process-automation.mp4"
                                                frameborder="1" auto>
                        ...
                        <div class="tab-pane" id="tab-6">
                            <div class="row">
                                <div class="col-lg-8 details order-2 order-lg-1">
                                    <h3>Next Batches Comming soon...</h3>
                                    ...
                                    <p class="d-flex justify-content-between align-items-center mb-3">
                                        ...
                                        Timings will be Weekends: 7:30 - 10:00  AM IST<br>
